...
namespace Valve.VR
{
    ...
    public class SteamVR_Input_ActionSet_default : Valve.VR.SteamVR_ActionSet
    {
        ...
        public virtual SteamVR_Action_Boolean LeftHandShoot
        {
            get
            {
                return SteamVR_Actions.default_LeftHandShoot;
            }
        }
        
        public virtual SteamVR_Action_Boolean RightHandShoot
        {
            get
            {
                return SteamVR_Actions.default_RightHandShoot;
            }
        }
